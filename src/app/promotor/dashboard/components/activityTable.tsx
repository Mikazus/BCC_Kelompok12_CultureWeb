...
export default function ActivityTable({ activities, isLoading = false }: ActivityTableProps) {
	return (
		<div>
			<h3 className="mb-3 text-[40px] font-semibold text-[#3E3022]">Aktivitas Terkini</h3>
			<div className="overflow-x-auto rounded-2xl border border-[#6D522D] bg-[#F8F6F1]">
				<table className="w-full min-w-165 border-separate border-spacing-0 px-2 py-3 text-left text-[20px] text-[#3E3022]">
					<thead>
						<tr className="text-[22px] font-medium text-[#4D3B29]">
